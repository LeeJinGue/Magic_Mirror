...
class Net_Widget(object):
  ...
  def setupUi(self, Dialog1):
    ...
    self.pushButton.setGeometry(QtCore.QRect(930, 10, 75, 23))
    self.pushButton.setObjectName("pushButton")

    self.NetList = QtWidgets.QListWidget(Dialog1)
    self.NetList.setGeometry(QtCore.QRect(20, 20, 500, 560))
    self.NetList.setObjectName("NetList")
    self.NetList.setFont(QtGui.QFont("산세리프", 20))
    self.NetList.alternatingRowColors()


    self.NetList.addItem("hello world!")
    self.NetList.addItem("hello world!")
    self.NetList.addItem("hello world!")
    self.NetList.addItem("hello world!")
