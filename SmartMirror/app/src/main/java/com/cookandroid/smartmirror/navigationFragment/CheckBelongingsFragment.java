...
public class CheckBelongingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.addItem(new belongingSetData("소지품세트333", "테스트용3", (ArrayList<String>) belongItemList.clone()));
        mAdapter.addItem(new belongingSetData("소지품세트4", "테스트43", (ArrayList<String>) belongItemList.clone()));
        mAdapter.addItem(new belongingSetData("소지품세트5", "테스트5", (ArrayList<String>) belongItemList.clone()));
        mAdapter.addItem(new belongingSetData("소지품세트6", "테스트용6", (ArrayList<String>) belongItemList.clone()));
        mAdapter.addItem(new belongingSetData("소지품세트7", "테스트용7", (ArrayList<String>) belongItemList.clone()));
