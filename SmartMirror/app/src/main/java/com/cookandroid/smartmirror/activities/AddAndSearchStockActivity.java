        ...
        stockAddEndBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(stockNameList.contains(selectedStockName)){
                    interestedStockData addedStock = new interestedStockData(1,myApp.getSelectedUser().getUser_num(), selectedStockName, sqlDB.getStockCodeByName(selectedStockName));
