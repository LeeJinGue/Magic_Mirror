...
//                    if(layoutsettingJson)
                    layoutData newLayoutData = new layoutData(layoutsettingJson.getInt("layout_id")
                            ,layoutsettingJson.getInt("user_num")
                            ,layoutsettingJson.getInt("loc")
                            ,layoutsettingJson.getInt("type"));
...
//        newSchedule.setMessage_id(set_message_id);
    ...
    public ArrayList<scheduleData> getScheduleByDate(String selectedDate, userData selectedUser){
        ...
        Cursor scheduleCursor = db.rawQuery("SELECT * " +
                ...
                "' AND start_time <= '" + MethodsHelper.getNextDate(selectedDate) +
                "';", null);
