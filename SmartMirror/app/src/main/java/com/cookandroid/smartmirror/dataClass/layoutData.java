...
public class layoutData {
    ...
    public static int[] TYPE_RES_ID = {R.drawable.ic_weather, R.drawable.ic_watch, R.drawable.ic_calendar, R.drawable.ic_stock, R.drawable.ic_message,R.drawable.ic_belonging,R.drawable.ic_belonging};
    // 날씨, 시계, 일정, 관심주, 메시지, 소지품세트 순서 -> layoutName
    public static String[] LAYOUT_NAME = {"날씨", "시계", "일정", "관심주", "메시지", "소지품세트","소지품세트"};
    // 좌상단, 우상단, 우하단, 좌하단 순서
